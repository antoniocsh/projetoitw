...
var vm = function () {
    ...
    $().ready(function () {
        ...
        $('#searchform').submit(function(event) {
            ...
            window.location.href = "gameDetails.html?id=" + athleteID;
            } else {
            // if the ID is not valid, show an error message
            $('#error-message').html('<span class="text-danger"><i class="fa fa-warning" aria-hidden="true"></i> Invalid Game ID</span>'); 
            }
          });
